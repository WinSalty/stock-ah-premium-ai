...
class DividendReinvestmentBacktestSummary(TimestampMixin, Base):
    ...
    ten_year_avg_annualized_return_pct: Mapped[Decimal | None] = mapped_column(DECIMAL(20, 8))
