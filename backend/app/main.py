...
from app.api.routes_dividend_reinvestment import router as dividend_reinvestment_router
...
from app.api.routes_qmt_review import router as qmt_review_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(qmt_review_router, prefix="/api", tags=["qmt-review"])
    app.include_router(notifications_router, prefix="/api", tags=["notifications"])
    app.include_router(query_router, prefix="/api", tags=["query"])
    app.include_router(
        dividend_reinvestment_router,
        prefix="/api",
        tags=["dividend-reinvestment"],
    )
