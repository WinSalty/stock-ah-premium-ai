...
DATA_QUERY_SPECS: dict[str, QueryDatasetSpec] = {
    ...
    "ah_stock_pair": QueryDatasetSpec(
        ...
        columns=(
            ...
            col("source", "来源", 140),
            col("effective_start_date", "生效开始", 120),
            col("effective_end_date", "生效结束", 120),
            col("is_active", "启用", 90),
        ),
    ...
    "official_ah_comparison": QueryDatasetSpec(
        ...
        keyword_fields=("a_ts_code", "hk_ts_code", "a_name", "hk_name"),
        date_field="trade_date",
    ...
    "sync_run": QueryDatasetSpec(
        ...
        columns=(
            ...
            col("started_at", "开始时间", 180),
            col("finished_at", "结束时间", 180),
            col("params_json", "参数", 240),
